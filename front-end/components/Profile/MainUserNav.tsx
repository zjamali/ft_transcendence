...
interface MainUserNav {
	setActive: (active:string)=> void,
	setOpenModal: (modal: boolean) =>void
}

const MainUserNav: React.FC<MainUserNav> = (props:MainUserNav) => {
	
	return (
		<div className="profile-wall-nav">
			<div className="profile-btn-div" onClick={(e) => { e.preventDefault(); props.setOpenModal(true)}}>
			...
			<div className="profile-btn-div" onClick={() => {props.setActive("DefaultData")}}>
				<div className="svg-div active">
			...
			<div className="profile-btn-div" onClick={() => {props.setActive("Friends")}}>
			...
			<div className="profile-btn-div" onClick={() => props.setActive("History")}>
				<div className="svg-div">
